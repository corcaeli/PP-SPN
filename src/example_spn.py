...
from spn.io.Graphics import plot_spn
from persist import write_spn_as_equationFile

#testSPN = example_spn_from_spn()
testSPN = example_spn_from_paper_about_spn()
plot_spn(testSPN, 'plots/testSPNAboutSPN.png')
write_spn_as_equationFile(testSPN, 'plots/testSPNAboutSPN.in')