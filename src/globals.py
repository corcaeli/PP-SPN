class Keys:
    ...
    CONFIG_GENERAL_JOIN_RANDOM_ZERO_ADDITIVE_MINUMUM = (
        "joint_random_zero_additive_minimum"
    )
    CONFIG_GENERAL_D_MULTIPLYER = "d_multiplyer"
    CONFIG_GENERAL_TRUNCATE_N = "truncate_n"
    CONFIG_GENERAL_TRUNCATE_T = "truncate_t"
    CONFIG_GENERAL_ADDITIVE_SHARING_OVER_INTEGER_MAX_SECRET = (
        "additive_sharing_over_integer_max_secret"
    )
    CONFIG_GENERAL_ADDITIVE_SHARING_OVER_INTEGER_SECURITY_PARAMETER = (
        "additive_sharing_over_integer_security_parameter"
    )
    CONFIG_GENERAL_ADDITIVE_SHARING_OVER_INTEGER_ALLOWED_BIT_LENGTH_OF_SECRET = (
        "additive_sharing_over_integer_allowed_bit_length_of_secret"
    )
...
class DataIDs:
    ...
    APPINVERSE_OF_TWO_POW_N_PLUS_1 = "appinverse_of_two_pow_n_plus_1"
    APPINVERSE_OF_TWO_POW_T_MINUS_1 = "appinverse_of_two_pow_t_minus_1"
