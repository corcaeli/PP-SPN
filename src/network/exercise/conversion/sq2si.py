...
from network.exercise.joint_random_sharing_of_zero.jriz import add_exercise_jriz
...
def sq2si_sharing_step(member, message_value):
    ...
    t = (
        2
        + member.additive_sharing_over_integer_security_parameter
        + member.additive_sharing_over_integer_allowed_bit_length_of_secret
    )
