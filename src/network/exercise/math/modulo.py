...
from globals import IDs, Values
...
def add_exercise_modulo_cheating(
    ...
    add_exercise_manager_inser_in_share(manager, data_id_result)
    add_exercise_manager_inser_in_share(manager, data_id)
    add_exercise_manager_inser_in_share(manager, data_id_of_modulant)
...
def add_exercise_modulo_paper(
    ...
    parameter_L = (
        manager.additive_sharing_over_integer_security_parameter
        + manager.additive_sharing_over_integer_allowed_bit_length_of_secret
        + 6
        + t
