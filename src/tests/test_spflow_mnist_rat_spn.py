...
for output in tf_output:
    ...
    for index in range(len(output)):
        ...
        if value > value_of_max:
            value_of_max = value
            index_of_max = index
    result_predictions_tf.append((index_of_max, value_of_max))

result_predictions_spn = []
for output in simple_output:
    index_of_max = -1
    value_of_max = -1
    for index in range(len(output)):
        value = output[index]
        if value > value_of_max:
            value_of_max = value
            index_of_max = index
    result_predictions_spn.append((index_of_max, value_of_max))
print("=====s=====")
print(result_predictions_tf)
print("==========")
print(result_predictions_spn)
